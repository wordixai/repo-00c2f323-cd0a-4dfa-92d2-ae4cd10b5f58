const AITracking = () => {
  ...
  return (
    <section id="tracking" className="py-20 px-4 sm:px-6 lg:px-8 section-bg">
            ...
            <div className="space-y-6">
              {steps.map((step, index) => (
                <div key={index} className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-white border-[#858585]/20 rounded-xl flex items-center justify-center flex-shrink-0">
