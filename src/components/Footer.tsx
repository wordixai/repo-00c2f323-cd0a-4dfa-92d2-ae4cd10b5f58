const Footer = () => {
  return (
    <footer id="contact" className="py-16 px-4 sm:px-6 lg:px-8 border-t border-[#2e2e2e] section-bg">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border-t border-[#2e2e2e] mt-8 pt-8 text-center text-zinc-400">
